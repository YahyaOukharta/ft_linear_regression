...
class LinearRegression:
    ...
    def train(self,):
        ...
        for i in range(self.N_ITERATIONS):
            # current predictions
            predictions = self.predict_with_standarized(standarized_x, std_theta0, std_theta1)
            ...
            self.previous_thetas.append(self.destandarize_theta(x, std_theta0, std_theta1))
    ...
    def visualize_animation(self):
        ...
        anim = animation.FuncAnimation(fig, frame, init_func=init,
                               frames=self.N_ITERATIONS, interval=0)
        plt.show()
        plt.close()
    ...
    def destandarize_theta(self, x, std_theta0, std_theta1):
        ...
        theta_cache.set(non_std_theta,(std_theta0, std_theta1,))
    ...
    def load_model(self):
        try:
            ...
            print("Model not found or has invalid format, initializing model with (0, 0)")
